---
title: How to Buy and Set Up Microsoft 365 Business Premium from Scratch
date: 2026-01-08
tags:
  - MSIntune
  - M365
...
categories:
  - Cloud
author: Radu Bogdan
description: Step-by-step guide to purchasing M365 Business Premium and initial tenant configuration. Covers real-world pricing in Europe including VAT, how to choose between Business Premium, E3 and E5 and the complete purchase flow from account creation to MFA setup.
draft: false
---
## Choosing the Right Plan

Microsoft offers three main business tiers: Basic, Standard and Premium. For this blog and my testing environment, I went with "*Business Premium*" because it's the only one that includes Intune and Entra ID P1. Also if you need device management and Conditional Access, the other two are not enough.

The pricing shows **$22**/user/month for annual billing so I've started with monthly to test things out first.
...
I'm based in Romania (Eastern Europe) so here's what the actual costs look like in my region:

**Business Premium** runs about 29 EUR per user per month with VAT included. That's what I pay for this blog's test tenant which aligns with typical EU pricing where VAT gets added on top of the base rate.

**E3** is listed at €37.70 per user per month before VAT on Microsoft's Romanian pricing page. Once VAT is applied, you're looking at roughly 45 to 50 EUR per month per user and that's about 1.5 times what Business Premium costs.
...
I chose 1 user and monthly billing and yes I know that monthly costs more per month but I've also aimed for flexibility while setting everything up, plus you can always switch to annual later once you're committed.

![](/images/Intune_P1_001.jpg)

![](/images/Intune_P1_100.jpg)
...
The fine print also mentions you can cancel *within 7 days* for a prorated refund, after that refunds are not possible.

>**Note**: Global, Billing and Reader admin roles will automatically get access to the billing account.

![](/images/Intune_P1_104.jpg)

## Order Confirmed

Done, your order is placed and Microsoft immediately asks you to set up MFA, this step is not optional since Microsoft enforces it for all new admin accounts.

The "Action required" box tells you to set up Microsoft Authenticator, you can use other authenticator apps but I suggest using Microsoft Authenticator.

![](/images/Intune_P1_109.jpg)

## Setting Up MFA

Microsoft walks you through the Authenticator setup, just manually download the app on your phone if you don't have it, then follow the prompts.

![](/images/Intune_P1_011.jpg)

The process is straightforward, just open the app, add a work account, scan the QR code (not shown here) and approve the test notification.
...
Each month you will receive a new automated email from Microsoft with your Premium subscription payment details:

![](/images/Intune_P1_110.jpg)
...
I'll cover those steps in detail within my new articles.
